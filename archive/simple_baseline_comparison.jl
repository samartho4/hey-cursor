...
println("🏆 Simple Baseline Comparison")
println("=" ^ 50)
...
# BASELINE 2: Simple Neural Network
function simple_neural_baseline(train_data, test_data)
    println("🧠 Training Simple Neural Network baseline...")
...
# MAIN EXECUTION
println("🚀 Starting simple baseline comparison...")

# Standard scenarios
println("\n📊 STANDARD SCENARIOS:")
lr_results = linear_regression_baseline(train_data, test_data)
nn_results = simple_neural_baseline(train_data, test_data)
...
nn_noisy = simple_neural_baseline(train_data, noisy_test_data)
...
# Save results
BSON.bson("results/simple_baseline_comparison_results.bson", results)

# Generate summary
summary = """
# Simple Baseline Comparison Summary
...
write("results/simple_baseline_comparison_summary.md", summary)

println("✅ Simple baseline comparison completed!")
println("📁 Results saved to results/simple_baseline_comparison_results.bson")
println("📄 Summary saved to results/simple_baseline_comparison_summary.md")
